...
namespace _26August
{
    internal class _26AugustEx3
    {
        static void Main(string[] args)
        {
            List<Product> productlist = new List<Product>();

            productlist.Add(new Product { ProductID = 1, ProductName = "Rice", ProductPrice = 45 });
            productlist.Add(new Product { ProductID = 2, ProductName = "Wheat", ProductPrice = 50 });
