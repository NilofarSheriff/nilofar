...
namespace _06OctoberAssignement_Adomvc_modelBinding
{
    ...
    public partial class LibraryEntities : DbContext
    {
        ...
        public virtual int Delete_row_Procedure(Nullable<int> bookid)
        {
            var bookidParameter = bookid.HasValue ?
                new ObjectParameter("bookid", bookid) :
                new ObjectParameter("bookid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Delete_row_Procedure", bookidParameter);
        }
