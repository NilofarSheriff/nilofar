...
using WebApplication_11october.Models;

namespace WebApplication_11october.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Scoped1 = _scopedservice1.generaterandomnumber();
            ViewBag.Scoped2 = _scopedservice2.generaterandomnumber();
